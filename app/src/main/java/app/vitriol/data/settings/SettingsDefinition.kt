...
internal class SettingsManager {
    val allDescriptors: List<SettingDescriptor> =
        listOf(
            SettingDescriptor(
                "showAppNames",
                "Show App Names",
    ...
    val appPickerDescriptors: Map<String, SettingDescriptor> =
        mapOf(
            "swipeUpApp" to
                SettingDescriptor(
                    "swipeUpApp",
                    ...
                    valueType = SettingValueType.APP_PREF,
                ),
            "swipeDownApp" to
                SettingDescriptor(
                    "swipeDownApp",
            ...
            "twoFingerSwipeUpApp" to
                SettingDescriptor(
                    "twoFingerSwipeUpApp",
                    "2Finger Swipe Up App",
                    category = SettingCategory.SWIPE_2FINGERS_GESTURES,
                    type = SettingType.APP_PICKER,
                    valueType = SettingValueType.APP_PREF,
                ),
            "twoFingerSwipeDownApp" to
                SettingDescriptor(
                    "twoFingerSwipeDownApp",
                    "2Finger Swipe Down App",
                    category = SettingCategory.SWIPE_2FINGERS_GESTURES,
                    type = SettingType.APP_PICKER,
                    valueType = SettingValueType.APP_PREF,
                ),
            "twoFingerSwipeRightApp" to
                SettingDescriptor(
                    "twoFingerSwipeRightApp",
                    "2Finger Swipe Right App",
                    category = SettingCategory.SWIPE_2FINGERS_GESTURES,
                    type = SettingType.APP_PICKER,
                    valueType = SettingValueType.APP_PREF,
                ),
            "twoFingerSwipeLeftApp" to
                SettingDescriptor(
                    "twoFingerSwipeLeftApp",
                    "2Finger Swipe Left App",
                    category = SettingCategory.SWIPE_2FINGERS_GESTURES,
                    type = SettingType.APP_PICKER,
                    valueType = SettingValueType.APP_PREF,
                ),
    ...
    fun getSettingsByCategory(): Map<SettingCategory, List<SettingDescriptor>> = allDescriptors.groupBy { it.category }
